...
const Footer = () => {
  ...
  <div className="max-w-2xl mx-auto text-center">
    <Link href="#" className="inline-block"><img src={Logo} alt="logo" className="w-48" /></Link>
    <p className="text-sm mt-8 text-gray-200">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean gravida,
      ...
      mi eu pulvinar cursus. <Link href="#" className="text-sm font-semibold text-blue-500">Read
        more...</Link></p>
    <ul className="flex items-center justify-center flex-wrap gap-y-3 gap-x-6 mt-8">
      ...
      <li><Link href="#">
          <svg xmlns="http://www.w3.org/2000/svg" className="inline w-6 h-6" viewBox="0 0 24 24">
            <linearGradient id="Link" x1="-37.106" x2="-26.555" y1="-72.705" y2="-84.047" gradientTransform="matrix(0 -1.982 -1.844 0 -132.522 -51.077)" gradientUnits="userSpaceOnUse">
              <stop offset={0} stopColor="#fd5" />
              <stop offset=".5" stopColor="#ff543e" />
              <stop offset={1} stopColor="#c837ab" />
            </linearGradient>
            <path fill="url(#Link)" d="M1.5 1.633C-.386 3.592 0 5.673 0 11.995c0 5.25-.916 10.513 3.878 11.752 1.497.385 14.761.385 16.256-.002 1.996-.515 3.62-2.134 3.842-4.957.031-.394.031-13.185-.001-13.587-.236-3.007-2.087-4.74-4.526-5.091C18.89.029 18.778.005 15.91 0 5.737.005 3.507-.448 1.5 1.633z" data-original="url(#Link)" />
  ...
  <ul className="grid max-sm:grid-cols-1 max-lg:grid-cols-2 lg:grid-cols-4 gap-12 mt-20">
    <li className="flex items-center">
      ...
      <Link href="#" className="text-blue-500 text-sm ml-3">
    ...
    <li className="flex items-center">
      ...
      <Link to="#" className="text-blue-500 text-sm ml-3">
  ...
  <div className="flex max-md:flex-col gap-4">
    <ul className="flex flex-wrap gap-4">
      <li className="text-sm">
        <Link href="#" className="text-blue-500 font-semibold hover:underline">Terms of Service</Link>
      </li>
      <li className="text-sm">
        <Link href="#" className="text-blue-500 font-semibold hover:underline">Privacy Policy</Link>
      </li>
      <li className="text-sm">
        <Link href="#" className="text-blue-500 font-semibold hover:underline">Security</Link>
      </li>
    </ul>
    <p className="text-sm text-gray-200 md:ml-auto">© ReadymadeUI. All rights reserved.</p>
  </div>
</footer>
